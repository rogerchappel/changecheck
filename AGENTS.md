# Agent Operating Instructions for /tmp/changecheck

This file defines how AI agents and human maintainers should work in `/tmp/changecheck`.

## Project Context

- Project: `/tmp/changecheck`
- Repository: ``
- Primary maintainer: ``
- Default branch: ``
- Package manager: ``
